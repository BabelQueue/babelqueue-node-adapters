...
/**
 * Merge out-of-band `extra` headers onto an already-built `base` header map **without clobbering**
 * the contract headers in `base` (they win a key collision) and dropping blanks. The result is
 * `base`, mutated in place.
 */
